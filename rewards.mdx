...
<Steps>
  ...
  <Step title="Reward Pool Creation">
    ...
    For example, if eligible nodes have a combined total of 100,000,000 $DRIA Points, the total reward pool will be 2,500 USD worth of ETH to be shared among all eligible nodes.
  ...
  <Step title="Percentile Distribution">
    Among eligible nodes, participants are ranked by their total points and divided into percentiles. The reward distribution follows this structure:
    
    - **Top 10%** (90th+ percentile): 20% of reward pool
    - **80-90th percentile**: 18% of reward pool  
    - **70-80th percentile**: 16% of reward pool
    - **60-70th percentile**: 14% of reward pool
    - **50-60th percentile**: 12% of reward pool
    - **40-50th percentile**: 9% of reward pool
    - **30-40th percentile**: 6% of reward pool
    - **Bottom 30%**: 5% of reward pool
  </Step>
    ...
    **Your actual reward calculation:**
    ...
    <Info>
      **Example:** If you're in the top 10% with 5,000,000 points, your percentile has 50,000,000 total points, and the total pool is 2,500 USD:
      Your reward = (5,000,000 / 50,000,000) × 20% × 2,500 USD = 50 USD worth of ETH
    </Info>
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Claiming Rewards" icon="wallet">
    Rewards are calculated in **USD value** but distributed as **ETH equivalent** and can be claimed by logging into the [dria.co/edge-ai](https://dria.co/edge-ai) dashboard with the wallet address connected to your node.
  </Card>
  ...
  <Card title="Reporting" icon="chart-bar">
    Monthly reports will detail total points earned, reward pool size (in USD), percentile distributions, and individual reward allocations (ETH equivalent values).
  </Card>
</CardGroup>
