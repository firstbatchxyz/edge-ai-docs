...
<Steps>
  ...
  <Step title="Percentile Distribution">
    ...
    - **Top 10%**: 15% of reward pool
    - **Top 20%**: 13% of reward pool  
    - **Top 30%**: 12% of reward pool
    - **Top 40%**: 10% of reward pool
    - **Top 50%**: 10% of reward pool
    - **Top 60%**: 10% of reward pool
    - **Top 70%**: 10% of reward pool
    - **Top 80%**: 8% of reward pool
    - **Top 90%**: 7% of reward pool
    - **Remaining nodes**: 5% of reward pool
  </Step>
