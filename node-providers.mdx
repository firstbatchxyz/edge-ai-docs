...
[nodes.garden](https://nodes.garden) is a one-click multichain node as a service platform which helps you run Dria nodes without technical knowledge.

**Getting Started:**

1.  **Purchase a Dria Node:**
    *   Go to [nodes.garden/dashboard](https://nodes.garden/dashboard)
    *   Select Dria
    *   Click Purchase to complete your order
    *   On the Node page, wait until the status changes to Online

2.  **Retrieve Your Keys:**
    *   Once your node is Online, click Node Data next to your subscription
    *   Copy your seed phrase to import into your wallet

3.  **Import Keys & Connect to the Dria Dashboard:**
    *   Import the seed phrase into any EVM-compatible wallet (MetaMask, Rabby)
    *   Go to [dria.co/edge-ai/my-node](https://dria.co/edge-ai/my-node)
    *   Connect the wallet you just imported to see your node status and metrics

**Links:**
- [Website](https://nodes.garden)
- [X (Twitter)](https://twitter.com/nodes_garden)

---

### Messiah Network

[Messiah Network](https://app.messiah.network/nodehub/node-shop) enables quick deployment of Dria nodes with a guided checkout experience.

**Getting Started:**

1.  **Choose Your Nodes:**
    *   Go to [app.messiah.network/nodehub/node-shop](https://app.messiah.network/nodehub/node-shop).
    *   Select the number of Dria nodes you want to deploy.

2.  **Set the Duration:**
    *   Pick how long you would like the nodes to run.
    *   Review the plan details in your cart.

3.  **Deploy Your Order:**
    *   Open your cart to confirm the configuration.
    *   Click **Deploy** to start provisioning the nodes.

**Links:**
- [Website](https://app.messiah.network/nodehub/node-shop)
